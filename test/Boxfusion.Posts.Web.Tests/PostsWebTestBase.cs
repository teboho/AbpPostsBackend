...
{
    public abstract class PostsWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static PostsWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(PostsWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<PostsDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<PostsDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<PostsDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<PostsDbContext, Task<T>> func)
        {
            T result;
